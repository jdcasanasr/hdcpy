...
# Load data from file
data_file = '/home/jdcasanasr/Development/hdcpy/logs/ucihar.tsv'  # Change this to your file name
data = []
...
filtered_data = [entry for entry in data if entry[1] in range(2, 11, 1)]
