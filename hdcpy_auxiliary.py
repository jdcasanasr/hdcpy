...
def replace_features(feature_vector:np.array, feature_dictionary:dict) -> np.array:
    vectorized_substitution = np.vectorize(lambda feature: feature_dictionary[feature])

    return vectorized_substitution(feature_vector)
